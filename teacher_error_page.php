...
<!-- Required meta tags --> 
<meta charset = "utf-8"/>
<meta name="sitePath" content="http://localhost/GenCyber/teacher_error_page.php" />
  ...
  <div style="font-size:1.0em; min-height:60vh" class="wrapper-main">
    ...
    <div style="font-size:24px; min-height:60vh;">
        <center>
            ...
            <br><p>Click <a href="http://localhost/GenCyber/teacher_landing.php">here</a> to go back to the Homepage.</p>
            <!--Hey👋, 👨‍⚖!-->
        </center>
    </div>
    <div>
