...
<p class="notes">Note: This is my reset-password template</p>
<body>
  <div class="wrapper-header">
      ...
      <a class="button-general button-signup" href="http://localhost/GenCyber/signup.php">Sign Up</a>
  ...
  <div><p>Add password-reset stuff here</p></div>
